...
class ReconcileInventory extends Command
{
    ...
    public function handle(): int
    {
        ...
        /*
         * 1. Get current stock levels for this tenant.
         */
         ...
         *    product_id-warehouse_id => calculated quantity
         */
        $expected = [];
        ...
        /*
         * 5. Compare calculated quantities with stock_levels.
         */
        $discrepancies = 0;
        ...
        /*
         * 6. Check calculated keys that don't have a stock_level row.
         */
