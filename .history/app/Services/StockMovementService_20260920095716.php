...
{
    public function create(array $data, int $tenantId): StockMovement
    {
    ...
    private function stockIn(array $data, int $tenantId): StockMovement
    {
        ...
        if (!$stockLevel) {
            ...
            // Lock the newly-created row too.
            $stockLevel->refresh();
        }
    ...
    private function transfer(array $data, int $tenantId): StockMovement
    {
        ...
        /*
         * Always lock the two rows in a consistent order.
         * This helps reduce deadlock risk when two transfers
         * happen in opposite directions at the same time.
         */
        $warehouseIds = [
            $fromWarehouseId,
            $toWarehouseId,
        ...
        $sourceStock = $stockLevels->get($fromWarehouseId);
        $destinationStock = $stockLevels->get($toWarehouseId);
