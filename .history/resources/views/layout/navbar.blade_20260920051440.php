        ...
        <div class="header-content">
                    ...
                    <ul class="navbar-nav header-right main-notification">
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                <img src={{ asset('images.png') }} width="20" alt="" />
                                <div class="header-info">
                                    ...
                                    {{-- @elseif (auth()->user()->hasRole('manager'))
                                        <small> ادمین سطح یک</small>
                                    @elseif (auth()->user()->hasRole('admin'))
                                        <small>ادمین سطح دو</small>
                                    @endif --}}
                                </div>
                            </a>
            ...
            <div class="sub-header">
                {{-- <div class="d-flex align-items-center flex-wrap mr-auto">
                            <h5 class="dashboard_bar">داشبورد</h5>
                        </div>
                        <div class="d-flex align-items-center">
                            <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">روز </a>
                            <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">ماه </a>
                            <a href="javascript:void(0);" class="btn btn-xs btn-primary light">سال</a>
                        </div> --}}
            </div>
        </div>
    </div>
